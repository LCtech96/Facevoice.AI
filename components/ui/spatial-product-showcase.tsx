...
export default function EarbudShowcase() {
  ...
  return (
    <div className="relative min-h-[600px] w-full bg-black text-zinc-100 overflow-hidden selection:bg-zinc-800 flex flex-col items-center justify-center rounded-2xl border border-white/5">
