    ...
    <>
      <div
        className={cn(
          ...
          "hover:shadow-2xl hover:shadow-[var(--accent-blue)]/10",
      ...
      >
        <div
          ...
          style={{
            background: "radial-gradient(circle at 50% 70%, var(--accent-blue) 0%, transparent 70%)",
        ...
        <h3
          className="text-lg font-semibold text-[var(--text-primary)] mt-4 transition-all duration-300"
          style={{
        ...
        <div
          className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-1.5 text-xs text-[var(--text-secondary)] transition-all duration-300"
          style={{
    ...
    >
      ...
      <button
        ...
        className={cn(
          ...
          "rounded-full bg-[var(--background-secondary)]/50 backdrop-blur-md",
      ...
      >
        <div
          className={cn("relative overflow-hidden", "rounded-2xl", "bg-[var(--card-background)]", "ring-1 ring-[var(--border-color)]", "shadow-2xl")}
          style={{
            ...
            >
              {projects.map((project) => (
                <img
                  ...
                  alt={project.title}
                  className="w-full h-auto max-h-[70vh] object-contain bg-[var(--background)] flex-shrink-0"
                  style={{ minWidth: "100%" }}
                />
              ))}
            </div>

            <div className="absolute inset-0 pointer-events-none bg-gradient-to-t from-[var(--card-background)]/20 via-transparent to-[var(--card-background)]/10" />
          </div>

          <div
            className={cn("px-6 py-5", "bg-[var(--card-background)]", "border-t border-[var(--border-color)]")}
            style={{
              opacity: animationPhase === "complete" && !isClosing ? 1 : 0,
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <h3 className="text-lg font-medium text-[var(--text-primary)] tracking-tight truncate h-7">
                  {currentProject?.title}
                </h3>
                <div className="flex items-center gap-3 mt-1">
                  <p className="text-sm text-[var(--text-secondary)]">
                    <kbd className="px-1.5 py-0.5 mx-0.5 text-xs font-medium bg-[var(--background-secondary)] text-[var(--text-secondary)] rounded border border-[var(--border-color)]">
                      ←
                    </kbd>
                    <kbd className="px-1.5 py-0.5 mx-0.5 text-xs font-medium bg-[var(--background-secondary)] text-[var(--text-secondary)] rounded border border-[var(--border-color)]">
                      →
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "bg-[var(--card-background)] border border-[var(--border-color)]",
          "cursor-pointer hover:ring-2 hover:ring-[var(--accent-blue)]/50",
