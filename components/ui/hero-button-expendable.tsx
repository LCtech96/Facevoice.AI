...
export default function HeroButtonExpandable() {
  ...
  return (
    <>
      <div className="relative flex min-h-[600px] flex-col items-center justify-center overflow-hidden bg-[var(--background)] px-4 sm:px-6 py-12 sm:py-20 rounded-2xl border border-[var(--border-color)]">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 sm:gap-8 text-center">
          <motion.div 
            ...
            className="inline-flex items-center rounded-full border border-[var(--border-color)] bg-[var(--card-background)]/50 px-3 py-1 text-sm font-medium text-[var(--text-primary)] backdrop-blur-sm"
          >
            <span className="flex h-2 w-2 rounded-full bg-[var(--accent-blue)] mr-2"></span>
          ...
          <motion.h1 
            ...
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-[var(--text-primary)] max-w-4xl"
          >
          ...
          <motion.p 
            ...
            className="text-base sm:text-lg md:text-xl text-[var(--text-secondary)] max-w-2xl px-4 leading-relaxed"
          >
            ...
            {!isExpanded && (
              <motion.div className="inline-block relative mt-4">
                <motion.div
                  ...
                  layout
                  layoutId="cta-card"
                  className="absolute inset-0 bg-[var(--accent-blue)]"
                />
                <motion.button
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute inset-0 pointer-events-none bg-gradient-to-br from-blue-800 via-blue-700 to-indigo-900"
              />
